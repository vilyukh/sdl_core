...
if(apr_INCLUDE_DIR)
    ...
    if(EXISTS "${apr_INCLUDE_DIR}/apr-1/apr_version.h")
        ...
        file(
            STRINGS
                "${apr_INCLUDE_DIR}/apr-1/apr_version.h"
...
if(apr_LIBRARY AND apr_INCLUDE_DIR)
    ...
    message(
        STATUS
            "Found apr: ${apr_LIBRARY} (found version \"${apr_VERSION_STRING}\")"
    )
else()
